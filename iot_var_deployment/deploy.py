...
if __name__ == "__main__":
    with IotDeployment("iot_base_app", "PI-251") as deployment:
        deployment.create_config_db("../iot_repository/iot.sl3")
        deployment.host_settings('192.168.1.251')
        deployment.device_settings([['PI-251.ADS1115.1', 'DigitalInput', 'ADS1115', 'I2C', 1, 0x48, 60,
        ...
        deployment.sensor_settings([['PI-251.KYES516.1', 'KYES516', 'PI-251.ADS1115.1', 0, 30,
